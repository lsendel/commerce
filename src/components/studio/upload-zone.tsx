...
export const UploadZone: FC<UploadZoneProps> = ({
  ...
  return (
    <div
      ...
      class="relative flex flex-col items-center justify-center w-full min-h-[280px] rounded-2xl border-2 border-dashed border-gray-300 bg-gray-50 transition-colors duration-200 cursor-pointer hover:border-brand-400 hover:bg-brand-50/30"
    >
      ...
      <div data-upload-idle class={existingImageUrl ? "hidden" : "flex flex-col items-center gap-3 p-8 text-center"}>
        {/* Upload icon */}
        <div class="flex items-center justify-center w-16 h-16 rounded-full bg-brand-100 text-brand-500">
          <svg class="w-8 h-8" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5">
            <path stroke-linecap="round" stroke-linejoin="round" d="M3 16.5v2.25A2.25 2.25 0 005.25 21h13.5A2.25 2.25 0 0021 18.75V16.5m-13.5-9L12 3m0 0l4.5 4.5M12 3v13.5" />
          </svg>
        </div>
        <div>
          <p class="text-base font-semibold text-gray-700">Drop your pet's photo here</p>
      ...
      >
        <div class="relative w-full max-w-xs aspect-square rounded-xl overflow-hidden bg-white shadow-sm border border-gray-200">
          <img
