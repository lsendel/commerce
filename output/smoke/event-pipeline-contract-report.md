...
- Started: 2026-03-06T06:41:09.682Z
- Finished: 2026-03-06T06:41:09.874Z
- Status: passed
- Taxonomy version: week-46-v1
- Known taxonomy events: 62
- Discovered literal events: 53
- Unknown literal events: 0

## Checks

| Check | Status | Note |
| --- | --- | --- |
| contract-track-eventname | pass | trackEvent contract accepts eventName alias payloads. |
| contract-track-payload-fallback | pass | trackEvent contract accepts payload fallback body. |
| contract-track-dedupe-key | pass | trackEvent contract accepts dedupe key field. |
| contract-response-201-delivery | pass | trackEvent 201 response includes delivery metadata. |
| contract-response-200-delivery | pass | trackEvent 200 dedupe response includes delivery metadata. |
| taxonomy-rejects-unknown | pass | taxonomy rejects unknown events. |
| taxonomy-discovered-literals | pass | all discovered literal event names are represented in taxonomy. |
