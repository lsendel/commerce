...
export const AffiliateRegisterPage: FC<{
  ...
  return (
    <div class="max-w-2xl mx-auto py-12 px-4">
      <h1 class="text-3xl font-bold mb-2">Become an Affiliate</h1>
      ...
      <div class="bg-white border rounded-lg p-6 mb-6">
        ...
        <ol class="space-y-3 text-sm text-gray-700">
          <li class="flex gap-3">
            <span class="bg-indigo-100 text-indigo-800 w-6 h-6 rounded-full flex items-center justify-center text-xs font-bold flex-shrink-0">
              1
            </span>
