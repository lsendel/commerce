    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <nav class="mb-6 text-sm" aria-label="Breadcrumb">
        <ol class="flex items-center gap-2 text-gray-500">
          ...
          <li><a href="/products" class="hover:text-brand-600 transition-colors">Products</a></li>
          <li><span class="text-gray-300">/</span></li>
          <li class="text-gray-900 font-medium truncate max-w-[200px]">{name}</li>
        </ol>
      </nav>
          ...
          <div class="aspect-square rounded-2xl overflow-hidden bg-gray-50 border border-gray-100">
            {mainImage ? (
              ...
              <div class="w-full h-full flex items-center justify-center bg-brand-50">
                <svg class="w-24 h-24 text-brand-200" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <div class="mt-8 space-y-4">
              ...
              <div class="grid grid-cols-1 sm:grid-cols-2 gap-3">
                ...
                {bookingConfig?.location && (
                  <div class="flex items-center gap-3 p-3 rounded-xl bg-gray-50 sm:col-span-2">
                    <div class="w-9 h-9 rounded-lg bg-brand-100 flex items-center justify-center shrink-0">
                      <svg class="w-5 h-5 text-brand-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <div>
                      ...
                      <div class="text-sm font-medium text-gray-900">{bookingConfig.location}</div>
                    </div>
                  </div>
                )}
              </div>
